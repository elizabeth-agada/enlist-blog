  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-3xl mx-auto px-6 py-12">
      <div class="flex items-center gap-4 mb-8">
        <button @click="router.back()" class="flex items-center gap-2 text-sm text-gray-500 hover:text-indigo-600 transition font-semibold">
          <ChevronLeft :size="16" /> Go Back
        </button>
        <span class="text-gray-300">|</span>
        <RouterLink to="/" class="flex items-center gap-1 text-sm text-gray-500 hover:text-indigo-600 transition font-semibold">
          <Home :size="15" /> Home
        </RouterLink>
      </div>
      <ErrorBoundary>
